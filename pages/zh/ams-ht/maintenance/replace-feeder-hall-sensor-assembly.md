---
path: zh/ams-ht/maintenance/replace-feeder-hall-sensor-assembly
title: "更换 AMS HT 出料霍尔检测组件"
description: "本文介绍了如何更换 AMS HT 出料霍尔检测组件"
tags: []
created: 2025-10-28T03:11:01.955Z
updated: 2025-11-17T03:02:10.480Z
source: https://wiki.bambulab.com/zh/ams-ht/maintenance/replace-feeder-hall-sensor-assembly
---

## 出料霍尔检测组件

在 AMS HT 后方靠近出料口的位置，设有一个出料霍尔组件。该组件用于检测耗材是否成功送出 AMS HT。当遇到断料、卡料等异常情况时，出料霍尔组件可帮助判断耗材的具体位置，便于用户快速排查问题。

![feeder_hall.png](https://wiki.bambulab.com/ams-ht/maintenance/feeder-hall-sensor-assembly/feeder_hall.png)
...
在 AMS HT 主板上拔出出料霍尔检测组件线缆的插头，插头位置如图所示。  
...
将出料霍尔组件线缆的插头插回到 AMS HT 主板的对应接口，接口位置如图所示。
