...
updated: 2026-05-06T08:28:40.158Z
...
以 P2S 为例，P2S 的缓冲器安装在背板中间位置，因此 1 个出口与缓冲器相连，而 4 个入口可连接 4 台 AMS，或连接额外的料管拓展口。  
![](https://wiki.bambulab.com/ams/multi-model-ams-compatibility-guide/p2s%E6%AD%A3%E7%A1%AE%E6%8E%A5%E6%B3%95.jpg)

其他机型的连接方式可根据缓冲器安装位置进行选择。

### 情况二：连接更多的外挂耗材

由于 P2S、X2D 打印机的缓冲器支持缠料检测功能，而 H 系列缓冲器内置于设备中，因此您可以参考情况一连接。这样 P2S、X2D 就能够使用缠料检测功能，4 个入口分别连接外挂料盘即可。

对于X1/P1 系列打印机，您可以直接将料管拓展口安装在进料口上，P1P 设有螺丝孔位固定料管拓展口。
