...
updated: 2026-04-14T08:58:54.724Z
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/高级设置页面.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/填充墙重叠50.png)

- 重叠率还可以设置为负值，负值说明填充和墙完全不重叠，且中间留有一定的间隙。例如重叠率设置为-50%，从下图可以看出，稀疏填充和内墙已经完全没有重叠，且中间还有50%线宽的间隙。

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/填充墙重叠-50.png)

- 不过如果重叠率设置为负数，有可能会影响顶面和底面的外观，因为顶面和底面的走线将不会与墙铆接。

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/底面墙重叠-50.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/填充方向45°.png)

- **填充方向90°：**

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/填充方向90°.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/bridge/桥接方向45°.png)

- **桥接方向90°：**

![](https://wiki.bambulab.com/bambu-studio/parameter/bridge/桥接方向90°.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/1稀疏填充最小阈值15.png)

- **稀疏填充最小阈值100mm²：**

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/2稀疏填充最小阈值100.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/合并填充演示.gif)

# 识别狭窄内部实心填充

此选项用于自动识别内部狭窄的实心填充区域。开启后，将对狭窄实心区域使用同心填充图案打印，这样可以明显加快速度，否则使用默认的直线填充图案。

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/识别内部狭窄实心填充开.png)
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/识别内部狭窄实心填充关.png)

# 确保垂直外壳厚度

该参数用于在斜面表面附近添加实心填充，以保证垂直外壳厚度(顶部+底部实心填充）。**需要保证的垂直外壳厚度取决于设置的顶面壳体厚度（层数）和底面壳体厚度（层数）。**

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/顶部底部壳体厚度设置.png)

下图是一个示例，如果设置了底面壳体层数是4层并启用了**确保垂直外壳厚度**，那么在切片斜面的时候，垂直方向上不足四层的部分，会添加内部实心填充层。

![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/确保垂直壳体厚度原理.png)
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/确保垂直壳体厚度演1.png)
...
![](https://wiki.bambulab.com/bambu-studio/parameter/strength-advance-settings/内部桥接厚度演示.gif)
