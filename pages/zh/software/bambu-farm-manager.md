...
updated: 2026-09-08T02:26:34.733Z
...
| 软件组件 | 最新版本 | 下载链接 |
| --- | --- | --- |
| **农场管家服务器** | 03.00.00.00 | [点击下载](https://public-cdn.bblmw.cn/upgrade/farm-manager/Bambu_Farm_Manager_Server_win-v03.00.00.00-20260901203014.exe) |
| **农场管家客户端** | 03.00.00 | [点击下载](https://public-cdn.bblmw.cn/upgrade/farm-manager/bambu-farm-manager-client-v3.0.0-8c114304-win32-x64.exe) |

[查看历史版本与发布说明](bambu-farm-release-notes.md)
...
3. 在“激活和设置页面”，可修改服务器的初始配置，如服务器名称，是否开启错峰启动。这里必须配置本地管理员账号和密码，请妥善保管该信息，后续需要使用本地账号访问农场服务器。

![image_(26).png](https://wiki.bambulab.com/software/bambu-farm-manager/image_(26).png)

## 添加打印机

添加打印机前需要检查：打印机固件版本已升级到目标版本；打印机已与handy解绑, 打印机账号显示为“登出状态”；打印机局域网模式为关闭状态。

![image27_zh.png](https://wiki.bambulab.com/software/bambu-farm-manager/image27_zh.png)
