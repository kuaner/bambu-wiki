---
path: zh/h2/maintenance/replace-filament-buffer
title: "更换 H2D & H2C 缓冲器及连接线"
description: "本文介绍了如何更换 H2D & H2C 缓冲器及连接线"
tags: []
created: 2025-03-25T01:58:37.166Z
updated: 2026-03-11T04:06:40.093Z
source: https://wiki.bambulab.com/zh/h2/maintenance/replace-filament-buffer
---

## 缓冲器

缓冲器安装在打印机上盖中，由两个滑块、两个弹簧和一个缓冲板组成。
...
![移除6pin.jpg](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/%E7%A7%BB%E9%99%A46pin.jpg)

### 步骤 3：断开 PTFE 管

- 按下打印机背面的气动接头，将两根 PTFE 管和缓冲器断开连接。

![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-7.png)

- 将缓冲滑块推到最右侧，然后按住气动接头，依次将两根与工具头连接的 PTFE 管与缓冲器断开连接；

![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-10.png)

![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-13.png)

![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-11.png)

> 注意：如果是 H2DL 打印机，还需断开气管。按压内置气泵的气动接头，即可抽出气管。  
...
![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-6.png)
...
> 下图是正确安装后的示意图。  
> ![安装磁铁_正确实例.jpg](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/%E5%AE%89%E8%A3%85%E7%A3%81%E9%93%81_%E6%AD%A3%E7%A1%AE%E5%AE%9E%E4%BE%8B.jpg)  
> 然后请重新把卸除的三颗螺丝重新安装上去。
...
![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-1.png)
...
![](https://wiki.bambulab.com/h2/maintenance/replace-filament-buffer/image-2.png)
...
您可以参考[更换 H2D 背板](replace-rear-panel.md)来安装打印机背板。
