---
path: zh/a1-mini/manual/a1-mini-firmware-update-from-SD-card
title: "通过 microSD 卡升级固件——A1 mini"
...
- 当 A1 mini 不联网、无法访问拓竹云服务时，可通过 microSD 卡和离线升级包升级打印机的固件。
- 需要回退至历史固件版本。
- 如果您在将打印机升级到最新版本时未使用 AMS Hub，那么在后续接入 AMS Hub 后，也需要通过 microSD 卡和离线升级包**将 AMS Hub 升级至最新版本**。

## 前提条件

> A1 mini 固件版本至少为 01.04.00.00，才支持离线升级固件功能。如果固件版本低于此版本号，请先将 A1 mini 联网升级。
...
请下载最新版本离线包，详情参见[此页面](https://bambulab.cn/zh-cn/support/firmware-download/a1-mini)。

### 步骤 2：取出 microSD 卡。

A1 mini **不支持热插拔卡**，因此每次取出 microSD 卡时，**请务必从菜单中安全弹出**，具体步骤如下：
...
### 步骤 4：将 microSD 插入打印机侧面卡槽，注意插入方向。
