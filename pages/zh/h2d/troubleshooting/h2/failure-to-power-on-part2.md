...
updated: 2026-07-29T04:37:32.760Z
...
> 在对打印机及其电子设备（包括工具头线缆）进行任何维护工作之前，请关闭打印机电源并断开电源连接，以避免发生屏幕误触或电路短路而引起额外的电子设备损坏和安全隐患。  
...
AP 板、 TH 板的 24V 电源需要通过 MC 板中转，当 MC 板出现异常时，将会导致打印机完全无法工作。而 MC 板的异常原因可能是 AP 板或 TH 板存在短路，以及 MC 板本身故障，因此步骤 1 需要确定 MC 板的工作状态。
...
1. MC 板指示灯正常：  
   设备无法工作的原因在 **AP 板模块**或 **TH 板模块**，请根据 AP 板和 TH 板对应的灯语状态，跳转到步骤 2 或步骤 3 进行排查。
2. MC 板指示灯异常或不亮：  
...
> **说明**：此处序号 1 的线来自单独选配加装的摄像头，因此没有连线是正常现象，并非故障原因。
