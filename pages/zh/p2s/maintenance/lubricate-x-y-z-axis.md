---
path: zh/p2s/maintenance/lubricate-x-y-z-axis
title: "P2S/X2D XYZ 轴清洁润滑"
...
> 温馨提醒： 如果您使用的是 ABS/ASA 这类挥发性的耗材，建议每周对 X 轴进行检查，如果两端有较明显的残留物，可以进行清洁和维护，清除残留物并重新打上润滑油。如果您较长时间（如超过两周）没有使用打印机，在再次使用前，请先检测X轴两端是否有凝固的残留物，可以在清除并打印润滑后再使用。
...
切断电源将工具头移动至最左侧极限位置，并将准备好的无纺布淋喷酒精。
...
接通电源，通过控制面板执行 "回中" 指令，待热床回归机械原点后，操作下降按钮将热床降至最低位置。
...
![](https://public-cdn.bblmw.com/wiki/new/p2s/maintenance/lubricate-x-y-z-axis/032.png)
...
![](https://public-cdn.bblmw.com/wiki/new/p2s/maintenance/lubricate-x-y-z-axis/029.png)

同样完成后操作打印机屏幕上下移动热床，使润滑油均匀扩散到轴承内部。

![](https://public-cdn.bblmw.com/wiki/new/p2s/maintenance/lubricate-x-y-z-axis/007.webp)
...
![](https://public-cdn.bblmw.com/wiki/new/p2s/maintenance/lubricate-x-y-z-axis/023.png)
